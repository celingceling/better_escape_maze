...
from .better_escape_maze_marl_env_cfg import BetterEscapeMazeMarlEnvCfg


class BetterEscapeMazeMarlEnv(DirectMARLEnv):
    cfg: BetterEscapeMazeMarlEnvCfg

    def __init__(self, cfg: BetterEscapeMazeMarlEnvCfg, render_mode: str | None = None, **kwargs):
