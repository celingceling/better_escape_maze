...
All the environments are registered in the `better_escape_maze` extension. They start
...
import better_escape_maze.tasks  # noqa: F401


def main():
    """Print all environments registered in `better_escape_maze` extension."""
